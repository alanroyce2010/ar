...
def get_intrinsic_matrix(field_of_view_deg, image_width, image_height):
    ...
    # Cu = image_width / 2.0
    # Cv = image_height / 2.0
    return np.array([[1055.55615, 0, 948.64667],
                     [0, 1055.55615, 572.65509],
                     [0, 0, 1.0]])
...
class CameraGeometry(object):
    def __init__(self, height=1.66, yaw_deg=0, pitch_deg=-25, roll_deg=0, image_width=1920, image_height=1080, field_of_view_deg=60):
        # scalar constants
        self.height = height
